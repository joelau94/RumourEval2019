    ...
    #             print("Tweet was not found! ID: ", foldr)
        ...
        if len(struct) > 1:
          ...
          if foldr == '553480082996879360':
            ...
            new_struct[foldr]['553495625527209985'] = \
                struct['553485679129534464']['553495625527209985']
            new_struct[foldr]['553495937432432640'] = \
                struct['553490097623269376']['553495937432432640']
            struct = new_struct
          else:
            new_struct = {}
            new_struct[foldr] = struct[foldr]
