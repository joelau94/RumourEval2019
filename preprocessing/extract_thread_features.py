...
#   feature_dict['wordcount'] = \
#    len(nltk.word_tokenize(re.sub(r'([^\s\w]|_)+',
#                                  '', tw['text'].lower())))
#   swearwords = []
...
#   feature_dict['Word2VecSimilarityWrtOther'] = \
#       help_prep_functions.getW2vCosineSimilarity(
...
def extract_thread_features_incl_response(conversation):
  ...
  for tw in conversation['replies']:
    ...
    #      help_prep_functions.getW2vCosineSimilarity(
    #          tokens, otherthreadtokens)
    # feature_dict['Word2VecSimilarityWrtSource'] = \
    #     help_prep_functions.getW2vCosineSimilarity(
    #     tokens, srctokens)
    # feature_dict['Word2VecSimilarityWrtPrev'] = \
    #     help_prep_functions.getW2vCosineSimilarity(
    #     tokens, prevtokens)
